...
#define analog_in_GPIO_Port GPIOC
...
#define SPI1_CIPO_Pin GPIO_PIN_11
#define SPI1_CIPO_GPIO_Port GPIOA
#define SPI1_COPI_Pin GPIO_PIN_12
#define SPI1_COPI_GPIO_Port GPIOA
